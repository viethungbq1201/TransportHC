...
public class ReportController {
    ...
    ApiResponse<TruckCostReportResponse> reportCostForTruck(@PathVariable("reportId") UUID id, @RequestBody ReportFromToRequest request) {
    ...
    ApiResponse<List<TruckScheduleDetailResponse>> reportSchedulesForTruck(@PathVariable("reportId") UUID id, @RequestBody ReportFromToRequest request) {
    ...
    ApiResponse<DriverCostReportResponse> reportCostForDriver(@PathVariable("reportId") UUID id, @RequestBody ReportFromToRequest request) {
