...
CREATE TABLE cost
(
    cost_id                BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL,
    user_cost_user_id      BIGINT       NULL,
    "description"          VARCHAR(255) NULL,
    price                  DECIMAL      NULL,
    documentary_proof      VARCHAR(255) NULL,
    date                   date         NULL,
    approve_status         VARCHAR(255) NULL,
    cost_type_cost_type_id BIGINT       NULL,
    schedule_schedules_id  BIGINT       NULL,
...
(
    cost_type_id BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL,
    name         VARCHAR(255) NULL,
...
(
    schedules_id               BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL,
    ...
    truck_truck_id             BIGINT       NULL,
    route_route_id             BIGINT       NULL,
    transaction_transaction_id BIGINT       NULL,
